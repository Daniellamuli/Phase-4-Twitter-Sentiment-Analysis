...
# ============================================
# PROJECT ROOT - Used for all file paths
# ============================================
...
# Raw data file
RAW_DATA_PATH = os.path.join(PROJECT_ROOT, "data", "judge-1377884607_tweet_product_company.csv")

# Processed data output
PROCESSED_DATA_PATH = os.path.join(PROJECT_ROOT, "data", "processed", "cleaned_tweets.csv")

# Saved models
BINARY_MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "binary_model.pkl")
MULTICLASS_MODEL_PATH = os.path.join(PROJECT_ROOT, "models", "multiclass_model.pkl")
...
POSITIVE_WORDS = {
    ...
    "nice", "brilliant", "genius", "impressive"
}
